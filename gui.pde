...
public void createGUI(){
  ...
  botonCalcular = new GButton(this, 2, 300, 100, 20);
  botonCalcular.setText("Calcular");
  botonCalcular.addEventHandler(this, "botonCalcular");
  botonNext = new GButton(this, 112, 300, 100, 20, "Next");
  botonPrev = new GButton(this, 212, 300, 100, 20, "Prev");
  botonCancela = new GButton(this, 312, 300, 90, 20, "Cancela");
...
GButton botonCalcular,botonNext,botonPrev,botonCancela; 
